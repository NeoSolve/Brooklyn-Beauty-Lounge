...
function brooklyn_beauty_register_acf_field_groups() {
	...
	acf_add_local_field_group( array(
		...
		'fields'                => array(
			...
			array(
				...
				'sub_fields'   => array(
					...
					array(
						...
						'name'  => 'link',
						'type'  => 'text',
						'instructions' => __( 'Supports regular URLs as well as tel: and mailto: links.', 'brooklyn-beauty' ),
					),
				),
			),
			array(
			...
			array(
				'key'        => 'field_brooklyn_beauty_local_business_schema_accordion',
				'label'      => __( 'Local Business Schema', 'brooklyn-beauty' ),
				'name'       => '',
				'type'       => 'accordion',
				'open'       => 0,
				'multi_expand' => 1,
			...
			array(
				'key'           => 'field_brooklyn_beauty_local_business_name',
				'label'         => __( 'Business Name', 'brooklyn-beauty' ),
				'name'          => 'local_business_name',
				'type'          => 'text',
				'default_value' => 'Brooklyn Beauty Lounge',
				'instructions'  => __( 'Used in BeautySalon JSON-LD schema.', 'brooklyn-beauty' ),
				'wrapper'       => array(
					'width' => '50',
				),
			),
			array(
				'key'           => 'field_brooklyn_beauty_local_business_telephone',
				'label'         => __( 'Business Telephone', 'brooklyn-beauty' ),
				'name'          => 'local_business_telephone',
				'type'          => 'text',
				'instructions'  => __( 'Use the canonical phone format for schema, for example: +1-718-555-1234.', 'brooklyn-beauty' ),
				'wrapper'       => array(
					'width' => '50',
				),
			),
			array(
				'key'   => 'field_brooklyn_beauty_local_business_street_address',
				'label' => __( 'Street Address', 'brooklyn-beauty' ),
				'name'  => 'local_business_street_address',
				'type'  => 'text',
				'wrapper' => array(
					'width' => '40',
				),
			...
			array(
				'key'   => 'field_brooklyn_beauty_local_business_address_locality',
				'label' => __( 'City / Locality', 'brooklyn-beauty' ),
				'name'  => 'local_business_address_locality',
				'type'  => 'text',
				'wrapper' => array(
					'width' => '15',
				),
			...
			array(
				'key'   => 'field_brooklyn_beauty_local_business_address_region',
				'label' => __( 'Region / State', 'brooklyn-beauty' ),
				'name'  => 'local_business_address_region',
				'type'  => 'text',
				'wrapper' => array(
					'width' => '15',
				),
			...
			array(
				'key'   => 'field_brooklyn_beauty_local_business_postal_code',
				'label' => __( 'Postal Code', 'brooklyn-beauty' ),
				'name'  => 'local_business_postal_code',
				'type'  => 'text',
				'wrapper' => array(
					'width' => '15',
				),
			...
			array(
				'key'   => 'field_brooklyn_beauty_local_business_address_country',
				'label' => __( 'Country Code', 'brooklyn-beauty' ),
				'name'  => 'local_business_address_country',
				'type'  => 'text',
				'instructions' => __( 'Use ISO country code, for example: US.', 'brooklyn-beauty' ),
				'wrapper' => array(
					'width' => '15',
				),
			),
			array(
				'key'   => 'field_brooklyn_beauty_local_business_price_range',
				'label' => __( 'Price Range', 'brooklyn-beauty' ),
				'name'  => 'local_business_price_range',
				'type'  => 'text',
				'instructions' => __( 'Example: $, $$, $$$.', 'brooklyn-beauty' ),
				'wrapper' => array(
					'width' => '25',
				),
			),
			array(
				'key'          => 'field_brooklyn_beauty_local_business_opening_hours',
				'label'        => __( 'Opening Hours Specification', 'brooklyn-beauty' ),
				'name'         => 'local_business_opening_hours',
				'type'         => 'repeater',
				'layout'       => 'row',
				'button_label' => __( 'Add Hours Row', 'brooklyn-beauty' ),
				'instructions' => __( 'Each row becomes one OpeningHoursSpecification entry in BeautySalon schema.', 'brooklyn-beauty' ),
				'sub_fields'   => array(
					array(
						'key'           => 'field_brooklyn_beauty_local_business_opening_hours_days',
						'label'         => __( 'Days', 'brooklyn-beauty' ),
						'name'          => 'days',
						'type'          => 'checkbox',
						'choices'       => array(
							'monday'    => __( 'Monday', 'brooklyn-beauty' ),
							'tuesday'   => __( 'Tuesday', 'brooklyn-beauty' ),
							'wednesday' => __( 'Wednesday', 'brooklyn-beauty' ),
							'thursday'  => __( 'Thursday', 'brooklyn-beauty' ),
							'friday'    => __( 'Friday', 'brooklyn-beauty' ),
							'saturday'  => __( 'Saturday', 'brooklyn-beauty' ),
							'sunday'    => __( 'Sunday', 'brooklyn-beauty' ),
						),
						'layout'        => 'horizontal',
						'return_format' => 'value',
						'wrapper'       => array(
					...
					array(
						'key'           => 'field_brooklyn_beauty_local_business_opening_hours_opens',
						'label'         => __( 'Opens', 'brooklyn-beauty' ),
						'name'          => 'opens',
						'type'          => 'time_picker',
						'display_format' => 'H:i',
						'return_format' => 'H:i',
					...
					array(
						'key'           => 'field_brooklyn_beauty_local_business_opening_hours_closes',
						'label'         => __( 'Closes', 'brooklyn-beauty' ),
						'name'          => 'closes',
						'type'          => 'time_picker',
						'display_format' => 'H:i',
						'return_format' => 'H:i',
			...
			array(
				'key'       => 'field_brooklyn_beauty_site_settings_seo_tab',
				'label'     => __( 'SEO / Open Graph', 'brooklyn-beauty' ),
				'name'      => '',
				'type'      => 'tab',
				'placement' => 'top',
				'endpoint'  => 0,
			...
			array(
				'key'        => 'field_brooklyn_beauty_default_og_accordion',
				'label'      => __( 'Default Open Graph', 'brooklyn-beauty' ),
				'name'       => '',
				'type'       => 'accordion',
				'open'       => 1,
				'multi_expand' => 1,
			...
			array(
				'key'   => 'field_brooklyn_beauty_default_og_title',
				'label' => __( 'Default OG Title', 'brooklyn-beauty' ),
				'name'  => 'default_og_title',
				'type'  => 'text',
				'instructions' => __( 'Used as fallback for homepage, blog index, search, 404 and other non-singular pages.', 'brooklyn-beauty' ),
			),
			array(
				'key'   => 'field_brooklyn_beauty_default_og_description',
				'label' => __( 'Default OG Description', 'brooklyn-beauty' ),
				'name'  => 'default_og_description',
				'type'  => 'textarea',
				'rows'  => 3,
			),
			array(
				'key'           => 'field_brooklyn_beauty_default_og_image',
				'label'         => __( 'Default OG Image', 'brooklyn-beauty' ),
			...
			array(
				'key'        => 'field_brooklyn_beauty_service_archive_og_accordion',
				'label'      => __( 'Services Archive Open Graph', 'brooklyn-beauty' ),
				'name'       => '',
				'type'       => 'accordion',
				'open'       => 0,
				'multi_expand' => 1,
			...
			array(
				'key'   => 'field_brooklyn_beauty_service_archive_og_title',
				'label' => __( 'Services Archive OG Title', 'brooklyn-beauty' ),
				'name'  => 'service_archive_og_title',
				'type'  => 'text',
			),
			array(
				'key'   => 'field_brooklyn_beauty_service_archive_og_description',
				'label' => __( 'Services Archive OG Description', 'brooklyn-beauty' ),
				'name'  => 'service_archive_og_description',
				'type'  => 'textarea',
				'rows'  => 3,
			),
			array(
				'key'           => 'field_brooklyn_beauty_service_archive_og_image',
				'label'         => __( 'Services Archive OG Image', 'brooklyn-beauty' ),
				'name'          => 'service_archive_og_image',
				'type'          => 'image',
				'return_format' => 'id',
				'preview_size'  => 'medium',
				'library'       => 'all',
			...
			array(
				'key'        => 'field_brooklyn_beauty_robots_txt_accordion',
				'label'      => __( 'Robots.txt', 'brooklyn-beauty' ),
				'name'       => '',
				'type'       => 'accordion',
				'open'       => 0,
				'multi_expand' => 1,
			...
			array(
				'key'           => 'field_brooklyn_beauty_robots_txt_content',
				'label'         => __( 'Robots.txt Content', 'brooklyn-beauty' ),
				'name'          => 'robots_txt_content',
				'type'          => 'textarea',
				'rows'          => 12,
				'new_lines'     => '',
				'instructions'  => __( 'Saved from the admin panel and synchronized to /robots.txt in the WordPress root. Leave empty to use the default rules.', 'brooklyn-beauty' ),
			),
			array(
	...
	acf_add_local_field_group( array(
		...
		'fields'                => array(
			...
			array(
				'key'           => 'field_brooklyn_beauty_single_service_hover_image',
				'label'         => __( 'Services Hover Image', 'brooklyn-beauty' ),
				'name'          => 'service_hover_image',
				'type'          => 'image',
				'return_format' => 'id',
				'preview_size'  => 'large',
				'library'       => 'all',
				'instructions'  => __( 'Shown when hovering the service image in service tiles and in the main hero on the Services page. If empty, the default image stays visible.', 'brooklyn-beauty' ),
			),
			array(
	...
	acf_add_local_field_group( array(
		'key'                   => 'group_brooklyn_beauty_open_graph_fields',
		'title'                 => __( 'Open Graph', 'brooklyn-beauty' ),
		'fields'                => array(
			array(
				'key'   => 'field_brooklyn_beauty_og_title',
				'label' => __( 'OG Title', 'brooklyn-beauty' ),
				'name'  => 'og_title',
				'type'  => 'text',
				'instructions' => __( 'Optional manual override for og:title.', 'brooklyn-beauty' ),
			),
			array(
				'key'   => 'field_brooklyn_beauty_og_description',
				'label' => __( 'OG Description', 'brooklyn-beauty' ),
				'name'  => 'og_description',
				'type'  => 'textarea',
				'rows'  => 4,
				'instructions' => __( 'Optional manual override for og:description.', 'brooklyn-beauty' ),
			),
			array(
				'key'           => 'field_brooklyn_beauty_og_image',
				'label'         => __( 'OG Image', 'brooklyn-beauty' ),
				'name'          => 'og_image',
				'type'          => 'image',
				'return_format' => 'id',
				'preview_size'  => 'medium',
				'library'       => 'all',
				'instructions'  => __( 'Optional manual override for og:image.', 'brooklyn-beauty' ),
			),
			array(
				'key'   => 'field_brooklyn_beauty_canonical_url',
				'label' => __( 'Canonical URL', 'brooklyn-beauty' ),
				'name'  => 'canonical_url',
				'type'  => 'url',
				'instructions' => __( 'Optional manual override for the canonical tag. If empty, the current page URL is used.', 'brooklyn-beauty' ),
			),
		),
		'location'              => array(
			array(
